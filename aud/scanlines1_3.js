;(async () => {
  // Extend the o0 object's prototype with a new setMode function
  ...
  // Complex visual effect chain using Hydra Synth functions
  voronoi(8.0, 0.03, 0.2).modulateScale(noise(1.2))
    .hue()
    .modulate(osc(10).modulateRepeat(noise(.8), ()=>a.fft[3]), ()=>a.fft[3])
    .rotate(0.4)
    ...
    .colorama(()=>a.fft[0])
    // .scale(0.9)  // Commented out scale adjustment
    .out()

  // Set canvas rendering style to 'auto'
